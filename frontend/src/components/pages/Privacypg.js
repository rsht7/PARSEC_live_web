    ...
    return(
        ...
        <div className="privacypage">
            ...
            <div className="priv-content">
                <h4>PARSEC LIVE, LLC   ---  PRIVACY POLICY</h4>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="pp-b">1. Types of Information We Collect</span>
                <br/>
                <br/>
                In order to better provide you with services relating to production of live music performances, we collect two types of information about our users: Personally Identifiable Information (“PII”) and Aggregate Information.
                <br/>
                <br/>
                <span className="pp-b">Personally Identifiable Information:</span> This refers to information that lets us know the specifics of who you are. When you engage in certain activities on this Site, such as registering for an account, downloading or purchasing a product or service, submitting content and/or posting content in the user forums, or sending us feedback, we may ask you to provide certain information about yourself.
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="pp-b">3. Cookies</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="pp-b">4. Release of Information</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="pp-b">6. User Choices on Collection and Use of Information</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="pp-b">7. Security of Your PII</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                Unfortunately, no data transmission over the Internet or any wireless network can be guaranteed to be 100% secure. As a result, while we strive to protect your PII, you acknowledge that: (a) there are security and <span className="pp-b-i">privacy</span> limitations inherent to the Internet which are beyond our control; and (b) the security, integrity and <span className="pp-b-i">privacy</span> of any and all information and data exchanged between you and us through this Site cannot be guaranteed.
                <br/>
                <br/>
                <span className="pp-b">8. Miscellaneous</span>
                <br/>
                <br/>
                ...
                Washington, District of Columbia 20018
                <br/>
                <span className="pp-b">Attn: </span>Privacy Compliance Officer
